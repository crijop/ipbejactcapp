...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UnidadeCurricular.ects'
        db.alter_column('distro_unidadecurricular', 'ects', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'UnidadeCurricular.ects'
        raise RuntimeError("Cannot reverse this migration. 'UnidadeCurricular.ects' and its values cannot be restored.")
