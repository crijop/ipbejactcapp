...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServicoDocente.docente'
        db.alter_column('distro_servicodocente', 'docente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.Docente'], null=True))


    def backwards(self, orm):
        
        # Changing field 'ServicoDocente.docente'
        db.alter_column('distro_servicodocente', 'docente_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['distro.Docente']))
