...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Docente.nome_profissional'
        db.delete_column('distro_docente', 'nome_profissional')

        # Adding field 'Docente.tipo_contrato'
        db.add_column('distro_docente', 'tipo_contrato', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['distro.TipoContrato']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Docente.nome_profissional'
        db.add_column('distro_docente', 'nome_profissional', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)
