...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cnaef.nome'
        db.alter_column('distro_cnaef', 'nome', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))


    def backwards(self, orm):
        
        # Changing field 'Cnaef.nome'
        db.alter_column('distro_cnaef', 'nome', self.gf('django.db.models.fields.CharField')(default='', max_length=120))
    ...
    models = {
        ...
        'distro.unidadecurricular': {
            ...
            'horas_lei_e': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'horas_lei_o': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'horas_lei_ot': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'horas_lei_pl': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'horas_lei_s': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'horas_lei_t': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'horas_lei_tc': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
