...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('distro_turma', (
            ...
            ('atividade_curso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.AtividadeCurso'])),
        ))
    ...
    models = {
        'distro.atividadecurso': {
            'Meta': {'object_name': 'AtividadeCurso'},
        ...
        'distro.turma': {
            ...
            'atividade_curso': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distro.AtividadeCurso']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
