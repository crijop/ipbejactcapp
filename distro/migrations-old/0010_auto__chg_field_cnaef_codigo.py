...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cnaef.codigo'
        db.alter_column('distro_cnaef', 'codigo', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'Cnaef.codigo'
        db.alter_column('distro_cnaef', 'codigo', self.gf('django.db.models.fields.IntegerField')())
