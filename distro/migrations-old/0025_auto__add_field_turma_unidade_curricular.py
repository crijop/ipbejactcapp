...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Turma.unidade_curricular'
        db.add_column('distro_turma', 'unidade_curricular', self.gf('django.db.models.fields.related.ForeignKey')(default=' ', to=orm['distro.UnidadeCurricular']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Turma.unidade_curricular'
        db.delete_column('distro_turma', 'unidade_curricular_id')
