...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ServicoDocente.horas'
        db.add_column('distro_servicodocente', 'horas', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'TipoAula.tipo'
        db.alter_column('distro_tipoaula', 'tipo', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Deleting field 'ServicoDocente.horas'
        db.delete_column('distro_servicodocente', 'horas')

        # Changing field 'TipoAula.tipo'
        db.alter_column('distro_tipoaula', 'tipo', self.gf('django.db.models.fields.CharField')(max_length=4))
