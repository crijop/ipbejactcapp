...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Turma.tipo_aula'
        db.add_column('distro_turma', 'tipo_aula', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['distro.TipoAula']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Turma.tipo_aula'
        db.delete_column('distro_turma', 'tipo_aula_id')
