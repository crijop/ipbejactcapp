...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Docente.escalao'
        db.add_column('distro_docente', 'escalao', self.gf('django.db.models.fields.IntegerField')(default=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Docente.escalao'
        db.delete_column('distro_docente', 'escalao')
