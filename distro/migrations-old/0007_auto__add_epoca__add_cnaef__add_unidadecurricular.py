...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('distro_unidadecurricular', (
            ...
            ('ects', self.gf('django.db.models.fields.FloatField')()),
            ('ano', self.gf('django.db.models.fields.IntegerField')()),
            ('semestre', self.gf('django.db.models.fields.IntegerField')()),
            ('epoca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.Epoca'])),
            ('horas_lei_t', self.gf('django.db.models.fields.IntegerField')()),
            ('horas_lei_tp_praticas', self.gf('django.db.models.fields.IntegerField')()),
            ('horas_lei_pl', self.gf('django.db.models.fields.IntegerField')()),
            ('horas_lei_tc', self.gf('django.db.models.fields.IntegerField')()),
            ('horas_lei_s', self.gf('django.db.models.fields.IntegerField')()),
            ('horas_lei_e', self.gf('django.db.models.fields.IntegerField')()),
            ('horas_lei_ot', self.gf('django.db.models.fields.IntegerField')()),
            ('horas_lei_o', self.gf('django.db.models.fields.IntegerField')()),
    ...
    models = {
        ...
        'distro.unidadecurricular': {
            ...
            'horas_lei_tp_praticas': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
