...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Reducao', fields ['nome']
        db.create_unique('distro_reducao', ['nome'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Reducao', fields ['nome']
        db.delete_unique('distro_reducao', ['nome'])
