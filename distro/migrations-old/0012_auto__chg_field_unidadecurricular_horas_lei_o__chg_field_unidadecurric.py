...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('distro_unidadecurricular', 'horas_lei_o', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'UnidadeCurricular.horas_lei_e'
        db.alter_column('distro_unidadecurricular', 'horas_lei_e', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'UnidadeCurricular.horas_lei_tc'
        db.alter_column('distro_unidadecurricular', 'horas_lei_tc', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'UnidadeCurricular.horas_lei_ot'
        db.alter_column('distro_unidadecurricular', 'horas_lei_ot', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'UnidadeCurricular.horas_lei_tp'
        db.alter_column('distro_unidadecurricular', 'horas_lei_tp', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'UnidadeCurricular.horas_lei_t'
        db.alter_column('distro_unidadecurricular', 'horas_lei_t', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'UnidadeCurricular.horas_lei_s'
        db.alter_column('distro_unidadecurricular', 'horas_lei_s', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'UnidadeCurricular.horas_lei_pl'
        db.alter_column('distro_unidadecurricular', 'horas_lei_pl', self.gf('django.db.models.fields.FloatField')(null=True))
