...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UnidadeCurricular.cnaef'
        db.alter_column('distro_unidadecurricular', 'cnaef_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.Cnaef'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'UnidadeCurricular.cnaef'
        raise RuntimeError("Cannot reverse this migration. 'UnidadeCurricular.cnaef' and its values cannot be restored.")
