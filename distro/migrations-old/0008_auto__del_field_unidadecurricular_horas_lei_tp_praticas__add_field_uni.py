...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UnidadeCurricular.horas_lei_tp_praticas'
        db.delete_column('distro_unidadecurricular', 'horas_lei_tp_praticas')

        # Adding field 'UnidadeCurricular.horas_lei_tp'
        db.add_column('distro_unidadecurricular', 'horas_lei_tp', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'UnidadeCurricular.horas_lei_tp_praticas'
        raise RuntimeError("Cannot reverse this migration. 'UnidadeCurricular.horas_lei_tp_praticas' and its values cannot be restored.")

        # Deleting field 'UnidadeCurricular.horas_lei_tp'
        db.delete_column('distro_unidadecurricular', 'horas_lei_tp')
    ...
    models = {
        ...
        'distro.cnaef': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'})
        },
        'distro.curso': {
        ...
        'distro.unidadecurricular': {
            ...
            'horas_lei_e': ('django.db.models.fields.IntegerField', [], {}),
            'horas_lei_o': ('django.db.models.fields.IntegerField', [], {}),
            'horas_lei_ot': ('django.db.models.fields.IntegerField', [], {}),
            'horas_lei_pl': ('django.db.models.fields.IntegerField', [], {}),
            'horas_lei_s': ('django.db.models.fields.IntegerField', [], {}),
            'horas_lei_t': ('django.db.models.fields.IntegerField', [], {}),
            'horas_lei_tc': ('django.db.models.fields.IntegerField', [], {}),
            'horas_lei_tp': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
