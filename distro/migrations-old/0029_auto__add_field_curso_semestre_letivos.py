...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Curso.semestre_letivos'
        db.add_column('distro_curso', 'semestre_letivos', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Curso.semestre_letivos'
        db.delete_column('distro_curso', 'semestre_letivos')
