...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Turma.observacoes'
        db.add_column('distro_turma', 'observacoes', self.gf('django.db.models.fields.TextField')(default='', max_length=500, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Turma.observacoes'
        db.delete_column('distro_turma', 'observacoes')
