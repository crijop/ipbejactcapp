...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Modulos.aprovacao'
        db.add_column('distro_modulos', 'aprovacao', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Adding field 'Turma.observacoesPresidencia'
        db.add_column('distro_turma', 'observacoesPresidencia', self.gf('django.db.models.fields.TextField')(default='', max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'Turma.observacoesDirEscola'
        db.add_column('distro_turma', 'observacoesDirEscola', self.gf('django.db.models.fields.TextField')(default='', max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'Turma.observacoesDirDepartamento'
        db.add_column('distro_turma', 'observacoesDirDepartamento', self.gf('django.db.models.fields.TextField')(default='', max_length=500, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Modulos.aprovacao'
        db.delete_column('distro_modulos', 'aprovacao')

        # Deleting field 'Turma.observacoesPresidencia'
        db.delete_column('distro_turma', 'observacoesPresidencia')

        # Deleting field 'Turma.observacoesDirEscola'
        db.delete_column('distro_turma', 'observacoesDirEscola')

        # Deleting field 'Turma.observacoesDirDepartamento'
        db.delete_column('distro_turma', 'observacoesDirDepartamento')
    ...
    models = {
        ...
        'distro.docentelogs': {
            'Meta': {'object_name': 'DocenteLogs'},
            'data_modificacao': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'docente': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distro.Docente']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_user': ('django.db.models.fields.IntegerField', [], {'default': '100', 'null': 'True', 'blank': 'True'})
        },
        'distro.epoca': {
        ...
        'distro.modulos': {
            'Meta': {'object_name': 'Modulos'},
            'aprovacao': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'departamento': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distro.Departamento']", 'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'servico_docente': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distro.ServicoDocente']", 'null': 'True', 'blank': 'True'})
        },
        'distro.reducao': {
        ...
        'distro.turma': {
            ...
            'observacoes': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'observacoesDirDepartamento': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'observacoesDirEscola': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'observacoesPresidencia': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '500', 'null': 'True', 'blank': 'True'}),
