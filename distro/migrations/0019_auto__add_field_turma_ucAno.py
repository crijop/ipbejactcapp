...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Turma.ucAno'
        db.add_column('distro_turma', 'ucAno',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['distro.UC_Ano']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Turma.ucAno'
        db.delete_column('distro_turma', 'ucAno_id')
