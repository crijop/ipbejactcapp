...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Docente.abreviatura'
        db.alter_column('distro_docente', 'abreviatura', self.gf('django.db.models.fields.CharField')(max_length=120, unique=True, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Docente.abreviatura'
        db.alter_column('distro_docente', 'abreviatura', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20, null=True, blank=True))
