...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UnidadeCurricular.semestre'
        db.alter_column('distro_unidadecurricular', 'semestre', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'UnidadeCurricular.ano'
        db.alter_column('distro_unidadecurricular', 'ano', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'UnidadeCurricular.semestre'
        raise RuntimeError("Cannot reverse this migration. 'UnidadeCurricular.semestre' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'UnidadeCurricular.ano'
        raise RuntimeError("Cannot reverse this migration. 'UnidadeCurricular.ano' and its values cannot be restored.")
