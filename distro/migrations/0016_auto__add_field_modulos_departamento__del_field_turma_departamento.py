...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Modulos.departamento'
        db.add_column('distro_modulos', 'departamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.Departamento'], null=True, blank=True), keep_default=False)

        # Deleting field 'Turma.departamento'
        db.delete_column('distro_turma', 'departamento_id')
    
    
    def backwards(self, orm):
        
        # Deleting field 'Modulos.departamento'
        db.delete_column('distro_modulos', 'departamento_id')

        # Adding field 'Turma.departamento'
        db.add_column('distro_turma', 'departamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.Departamento'], null=True, blank=True), keep_default=False)
