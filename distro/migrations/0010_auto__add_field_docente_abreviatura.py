...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Docente.abreviatura'
        db.add_column('distro_docente', 'abreviatura', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Docente.abreviatura'
        db.delete_column('distro_docente', 'abreviatura')
    ...
    models = {
        ...
        'distro.docente': {
            ...
            'abreviatura': ('django.db.models.fields.CharField', [], {'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
