...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ServicoDocente.docente'
        db.delete_column('distro_servicodocente', 'docente_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'ServicoDocente.docente'
        db.add_column('distro_servicodocente', 'docente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.Docente'], null=True, blank=True), keep_default=False)
