...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReducaoServicoDocente.observacoes'
        db.alter_column('distro_reducaoservicodocente', 'observacoes', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ReducaoServicoDocente.observacoes'
        raise RuntimeError("Cannot reverse this migration. 'ReducaoServicoDocente.observacoes' and its values cannot be restored.")
    ...
    models = {
        ...
        'distro.reducaoservicodocente': {
            ...
            'docente': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distro.Docente']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'observacoes': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
