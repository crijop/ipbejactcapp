...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DocenteLogs'
        db.create_table('distro_docentelogs', (
            ...
            ('id_user', self.gf('django.db.models.fields.IntegerField')(default=100, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('distro', ['DocenteLogs'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'DocenteLogs'
        db.delete_table('distro_docentelogs')
