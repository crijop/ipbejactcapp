...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ano'
        db.create_table('distro_ano', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ano', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('distro', ['Ano'])

        # Adding model 'CursosAno'
        db.create_table('distro_cursosano', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ano', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.Ano'], null=True, blank=True)),
            ('curso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.Curso'])),
        ))
        db.send_create_signal('distro', ['CursosAno'])

        # Adding model 'UC_Ano'
        db.create_table('distro_uc_ano', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unidadeCurricular', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.UnidadeCurricular'], null=True, blank=True)),
            ('cursosAno', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.CursosAno'])),
        ))
        db.send_create_signal('distro', ['UC_Ano'])


    def backwards(self, orm):
        # Deleting model 'Ano'
        db.delete_table('distro_ano')

        # Deleting model 'CursosAno'
        db.delete_table('distro_cursosano')

        # Deleting model 'UC_Ano'
        db.delete_table('distro_uc_ano')
    ...
    models = {
        ...
        'distro.cursosano': {
            'Meta': {'object_name': 'CursosAno'},
            'ano': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distro.Ano']", 'null': 'True', 'blank': 'True'}),
        ...
        'distro.uc_ano': {
            'Meta': {'object_name': 'UC_Ano'},
            'cursosAno': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distro.CursosAno']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'unidadeCurricular': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distro.UnidadeCurricular']", 'null': 'True', 'blank': 'True'})
        },
