...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Docente.regime_exclusividade'
        db.alter_column('distro_docente', 'regime_exclusividade', self.gf('django.db.models.fields.BooleanField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Docente.regime_exclusividade'
        db.alter_column('distro_docente', 'regime_exclusividade', self.gf('django.db.models.fields.BooleanField')())
