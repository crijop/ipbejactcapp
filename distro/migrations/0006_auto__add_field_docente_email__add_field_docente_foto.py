...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Docente.email'
        db.add_column('distro_docente', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, null=True, blank=True), keep_default=False)

        # Adding field 'Docente.foto'
        db.add_column('distro_docente', 'foto', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Docente.email'
        db.delete_column('distro_docente', 'email')

        # Deleting field 'Docente.foto'
        db.delete_column('distro_docente', 'foto')
    ...
    models = {
        ...
        'distro.docente': {
            ...
            'foto': ('django.db.models.fields.files.ImageField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
