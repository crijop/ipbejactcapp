...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DepartamentoAno'
        db.create_table('distro_departamentoano', (
        ...
        db.send_create_signal('distro', ['DepartamentoAno'])

        # Adding field 'Ano.estado'
        db.add_column('distro_ano', 'estado',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DepartamentoAno'
        db.delete_table('distro_departamentoano')

        # Deleting field 'Ano.estado'
        db.delete_column('distro_ano', 'estado')
    ...
    models = {
        'distro.ano': {
            ...
            'estado': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
        ...
        'distro.departamentoano': {
            'Meta': {'object_name': 'DepartamentoAno'},
            'ano': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distro.Ano']", 'null': 'True', 'blank': 'True'}),
        ...
        'distro.turma': {
            ...
            'ucAno': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distro.UC_Ano']"}),
