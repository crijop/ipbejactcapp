...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Modulos'
        db.create_table('distro_modulos', (
            ...
            ('servico_docente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['distro.ServicoDocente'], null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('distro', ['Modulos'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Modulos'
        db.delete_table('distro_modulos')
